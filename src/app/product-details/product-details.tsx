                ...
                <div className={classes("column-layout group_6")}>
                  ...
                  <div className={classes("row-layout group_8")}>
                    <IgrSelect outlined="false" label="Quantitiy" value={value1} change={(_c, e) => setValue1(e.detail.value)} className={classes("select")}>
                      <IgrSelectItem value="1" key="9838ea6a-9c82-4d6c-a779-5cc407294819">
                        <span key={uuid()}>1</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="4ec5bfaa-c1ff-43f2-b034-b893dfabe977">
                        <span key={uuid()}>2</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="ad6bffa0-1bde-4714-85f4-d09aa3d7fde8">
                        <span key={uuid()}>3</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="cb77879c-ffc1-4d71-985a-3c9ad0f0c230">
