              ...
              <div className={classes("column-layout products")}>
                <div className={classes("row-layout group_2")}>
                  ...
                  <div className={classes("row-layout group_3")}>
                    ...
                    <IgrButton variant="flat" clicked={(e: any) => dropdown?.current?.toggleTarget(e.target || e.i.nativeElement)} className={classes("button")}>
                ...
                <div className={classes("row-layout group_4")}>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_7")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_8")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_9")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_10")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_11")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
                  ...
                  <IgrCard className={classes("card")}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrButton variant="flat" className={classes("button_1 button_1_12")}>
                          <span className={classes("material-icons icon")} key={uuid()}>
                            <span key={uuid()}>add_shopping_cart</span>
                          </span>
                          <span key={uuid()}>ADD TO CART</span>
